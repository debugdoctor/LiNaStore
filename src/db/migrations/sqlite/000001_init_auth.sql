...
-- Compatible with SQLite, MySQL, and PostgreSQL (tested with sqlx migrations)
...
INSERT OR IGNORE INTO mig_records (version, applied_at)
VALUES ('000001_init_auth', CAST(strftime('%s','now') AS BIGINT));
